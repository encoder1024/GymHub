    ...
    <div className="pa4">
      ...
      <div className="mb4">
        ...
        {gym && (
          <div className="measure center pa4 bg-white shadow-1 br2">
            ...
            <p className="lh-copy measure">
              <strong>Descripción:</strong> {gym.description}
            </p>
            <p className="lh-copy measure">
              <strong>Ubicación:</strong> {gym.location}
            </p>
      ...
      <div className="mb4">
        ...
        <div className="flex flex-wrap justify-center">
          {!loading && !error && classes.length === 0 && gym && (
            <p>Aún no has programado clases para tu gimnasio.</p>
          )}
          {!loading &&
            !error &&
            classes.map((cls) => (
              <div
                key={cls.id}
                className="bg-white shadow-1 br3 pa3 ma3 w-100 w-40-m w-30-l flex flex-column justify-between"
              >
                <ClassCard
                  classInfo={cls}
                  onBook={() =>
                    alert(
                      "Esta función es solo informativa en el dashboard. Las reservas se hacen desde la vista del cliente.",
                    )
                  } // Botón de reservar en el dashboard del owner no debería hacer nada o llevar a "ver reservas"
                />
